...
-- Reverse the company RLS fence for billing.invoice_tax_lines
...
-- Reverse the company RLS fence for billing.purchase_invoice_lines
...
-- Reverse the company RLS fence for billing.sales_invoice_lines
