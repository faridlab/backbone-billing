...
pub fn create_stateless_routes(module: &crate::BillingModule) -> Router<()> {
    Router::new()
        .merge(create_agent_earning_routes(module.agent_earning_service.clone()))
        .merge(create_financial_period_routes(module.financial_period_service.clone()))
        .merge(create_payment_routes(module.payment_service.clone()))
        .merge(create_payment_gateway_detail_routes(module.payment_gateway_detail_service.clone()))
        .merge(create_payment_fee_routes(module.payment_fee_service.clone()))
        .merge(create_invoice_routes(module.invoice_service.clone()))
        .merge(create_invoice_party_routes(module.invoice_party_service.clone()))
        .merge(create_invoice_line_item_routes(module.invoice_line_item_service.clone()))
        .merge(create_provider_bank_account_routes(module.provider_bank_account_service.clone()))
        .merge(create_refund_request_routes(module.refund_request_service.clone()))
        .merge(create_settlement_routes(module.settlement_service.clone()))
}
