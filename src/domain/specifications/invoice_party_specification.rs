//! Specifications for InvoiceParty aggregate
//!
...
// Each predicate implements `Specification<InvoiceParty>` and can be combined
...
//
// pub struct ActiveInvoicePartySpec;
// impl Specification<InvoiceParty> for ActiveInvoicePartySpec {
//     fn is_satisfied_by(&self, e: &InvoiceParty) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
