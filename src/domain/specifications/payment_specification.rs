//! Specifications for Payment aggregate
//!
...
// Each predicate implements `Specification<Payment>` and can be combined
...
//
// pub struct ActivePaymentSpec;
// impl Specification<Payment> for ActivePaymentSpec {
//     fn is_satisfied_by(&self, e: &Payment) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
