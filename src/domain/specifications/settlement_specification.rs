//! Specifications for Settlement aggregate
//!
...
// Each predicate implements `Specification<Settlement>` and can be combined
...
//
// pub struct ActiveSettlementSpec;
// impl Specification<Settlement> for ActiveSettlementSpec {
//     fn is_satisfied_by(&self, e: &Settlement) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
