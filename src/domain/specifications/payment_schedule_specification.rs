//! Specifications for PaymentSchedule aggregate
//!
...
// Each predicate implements `Specification<PaymentSchedule>` and can be combined
...
//
// pub struct ActivePaymentScheduleSpec;
// impl Specification<PaymentSchedule> for ActivePaymentScheduleSpec {
//     fn is_satisfied_by(&self, e: &PaymentSchedule) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
