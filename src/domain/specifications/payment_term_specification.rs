//! Specifications for PaymentTerm aggregate
//!
...
// Each predicate implements `Specification<PaymentTerm>` and can be combined
...
//
// pub struct ActivePaymentTermSpec;
// impl Specification<PaymentTerm> for ActivePaymentTermSpec {
//     fn is_satisfied_by(&self, e: &PaymentTerm) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
