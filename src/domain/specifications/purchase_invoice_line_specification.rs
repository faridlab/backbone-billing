//! Specifications for PurchaseInvoiceLine aggregate
//!
...
// Each predicate implements `Specification<PurchaseInvoiceLine>` and can be combined
...
//
// pub struct ActivePurchaseInvoiceLineSpec;
// impl Specification<PurchaseInvoiceLine> for ActivePurchaseInvoiceLineSpec {
//     fn is_satisfied_by(&self, e: &PurchaseInvoiceLine) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
