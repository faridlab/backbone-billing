//! Specifications for Invoice aggregate
//!
...
// Each predicate implements `Specification<Invoice>` and can be combined
...
//
// pub struct ActiveInvoiceSpec;
// impl Specification<Invoice> for ActiveInvoiceSpec {
//     fn is_satisfied_by(&self, e: &Invoice) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
