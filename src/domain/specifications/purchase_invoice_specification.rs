//! Specifications for PurchaseInvoice aggregate
//!
...
// Each predicate implements `Specification<PurchaseInvoice>` and can be combined
...
//
// pub struct ActivePurchaseInvoiceSpec;
// impl Specification<PurchaseInvoice> for ActivePurchaseInvoiceSpec {
//     fn is_satisfied_by(&self, e: &PurchaseInvoice) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
