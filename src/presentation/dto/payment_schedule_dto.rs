...
impl PatchPaymentScheduleDto {
    ...
    pub fn has_changes(&self) -> bool {
        self.invoice_ref.is_some() || self.invoice_kind.is_some() || self.installment_no.is_some() || self.due_date.is_some() || self.amount.is_some() || self.paid_amount.is_some() || self.status.is_some()
    }
}
