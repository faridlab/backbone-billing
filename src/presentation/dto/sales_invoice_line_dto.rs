//! SalesInvoiceLine DTOs (Data Transfer Objects)
//!
...
/// Request DTO for creating a new SalesInvoiceLine
///
...
/// Request DTO for full update of a SalesInvoiceLine
///
...
/// Request DTO for partial update of a SalesInvoiceLine
///
...
impl PatchSalesInvoiceLineDto {
    ...
    pub fn has_changes(&self) -> bool {
        self.invoice_id.is_some() || self.company_id.is_some() || self.item_id.is_some() || self.revenue_account_id.is_some() || self.description.is_some() || self.quantity.is_some() || self.unit_price.is_some() || self.net_amount.is_some()
    }
}
...
/// Response DTO for SalesInvoiceLine entity
///
...
/// Paginated list response for SalesInvoiceLine entities
///
...
#[cfg_attr(feature = "openapi", derive(ToSchema))]
#[serde(rename_all = "camelCase")]
pub struct SalesInvoiceLineListResponseDto {
    /// List of items
    pub items: Vec<SalesInvoiceLineResponseDto>,
...
impl From<SalesInvoiceLine> for SalesInvoiceLineResponseDto {
    fn from(entity: SalesInvoiceLine) -> Self {
        Self {
            id: entity.id,
...
impl From<SalesInvoiceLine> for SalesInvoiceLineSummaryDto {
    fn from(entity: SalesInvoiceLine) -> Self {
...
impl From<CreateSalesInvoiceLineDto> for SalesInvoiceLine {
    fn from(dto: CreateSalesInvoiceLineDto) -> Self {
        Self {
            id: Uuid::new_v4(),
...
impl backbone_core::FromCreateDto<CreateSalesInvoiceLineDto> for SalesInvoiceLine {
    fn from_create_dto(dto: CreateSalesInvoiceLineDto) -> backbone_core::ServiceResult<Self> {
        Ok(SalesInvoiceLine::from(dto))
    }
}
...
// <<< CUSTOM DTOs
// Add custom DTOs specific to SalesInvoiceLine here.
